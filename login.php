            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-top-right">
                        <p><i class="fa-solid fa-code-compare"></i> Compare <i class="fa-solid fa-user"></i> Login <a href="register.php"><i class="fa-solid fa-lock"></i> Register</a></p>
                    </div>
                </div>
